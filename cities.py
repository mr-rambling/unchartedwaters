...
Velmore.cities['Seville'].harbour = pygame.Vector2(4804, 2190)
Velmore.cities['Ceuta'] = City("Ceuta", 
                    (4859, 2243),
...
Velmore.cities['Ceuta'].harbour = pygame.Vector2(4859, 2246)
Velmore.cities['Lisbon'] = City("Lisbon", 
                    (4757, 2165),
...
Velmore.cities['Lisbon'].harbour = pygame.Vector2(4755, 2166)